...
const ProofOfPickup: React.FC<Props> = ({ navigation }) => {
  ...
  const deliveryItems = [
    { id: 0, quantity: 2, itemName: "Blood" },
    { id: 1, quantity: 1, itemName: "Tissue" },
    { id: 2, quantity: 4, itemName: "Insulin" },
  ];
          ...
          {deliveryItems.map((item) => {
            ...
            return (
              <View key={item.id} style={styles.itemContainer}>
                <CustomText style={styles.itemTxt}>{t("request.item")} {item.quantity}</CustomText>
